      ...
      init(container) {
        ...
        return _asyncToGenerator(function* () {
          ...
          if (!_this.element) {
            ...
            _this.element = yield Object(_framework_delegate_c2e2e1f4_js__WEBPACK_IMPORTED_MODULE_4__["a"])(_this.delegate, container, component, ['ion-page', 'ion-page-invisible'], _this.params);
          }
        })();
      }
      /**
    ...
    const Nav = class {
      ...
      componentDidLoad() {
        ...
        return _asyncToGenerator(function* () {
          ...
          _this2.gesture = (yield __webpack_require__.e(
          /*! import() | swipe-back-35ad8e37-js */
          "swipe-back-35ad8e37-js").then(__webpack_require__.bind(null,
          /*! ./swipe-back-35ad8e37.js */
          "./node_modules/@ionic/core/dist/esm/swipe-back-35ad8e37.js"))).createSwipeBackGesture(_this2.el, _this2.canStart.bind(_this2), _this2.onStart.bind(_this2), _this2.onMove.bind(_this2), _this2.onEnd.bind(_this2));
      ...
      runTransition(ti) {
        ...
        return _asyncToGenerator(function* () {
          try {
            ...
            const leavingView = _this4.getActiveSync();

            const enteringView = _this4.getEnteringView(ti, leavingView);
            ...
            if (enteringView && enteringView.state === VIEW_STATE_NEW) {
              yield enteringView.init(_this4.el);
            }
            ...
            const result = requiresTransition ? yield _this4.transition(enteringView, leavingView, ti) : {
      ...
      transition(enteringView, leavingView, ti) {
        ...
        return _asyncToGenerator(function* () {
          ...
          const opts = ti.opts;
          const progressCallback = opts.progressAnimation ? ani => _this5.sbAni = ani : undefined;
          ...
          const {
            hasCompleted
          } = yield Object(_index_4d91f03a_js__WEBPACK_IMPORTED_MODULE_5__["t"])(animationOpts);
          return _this5.transitionFinish(hasCompleted, enteringView, leavingView, opts);
        })();
      }
