(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["form-form-module"], {
  ...
  function (module, __webpack_exports__, __webpack_require__) {
    ...
    var _form_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./form.page */
    "./src/app/form/form.page.ts");
    /* harmony import */


    var _loader_component_loader_component_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ../loader-component/loader-component.component */
    ...
    FormPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _core_core_module__WEBPACK_IMPORTED_MODULE_9__["CoreModule"], ng_recaptcha__WEBPACK_IMPORTED_MODULE_6__["RecaptchaModule"].forRoot(), _angular_router__WEBPACK_IMPORTED_MODULE_5__["RouterModule"].forChild([{
        path: '',
  ...
  function (module, __webpack_exports__, __webpack_require__) {
    ...
    "./node_modules/@ionic-native/network/ngx/index.js"); // import { File } from '@ionic-native/file/ngx';
    ...
    let FormPage = class FormPage {
      constructor(navCtrl, camera, loadingCtrl, toastController, http, route, router, platform, zone, network, storage) {
        ...
        this.myBoolean = false; // storageLength:int;

        this.float_length = 0; // this.postid = this.platform.getQueryParam("n");
        // alert(this.postid);

        this.postid = this.route.snapshot.paramMap.get('id'); // alert(this.blogID);
        // alert(this.postid);
      ...
      captchaResolved(response) {
        this.zone.run(() => {
          ...
          this.captchaResponse = response; // alert(this.captchaPassed);
        }); // alert(this.captchaPassed);
      }
      ...
      newpost() {
        //alert(this.title);
        this.loadingPresent();
        this.now = [this.postid]; // var tag={'category':this.postid}
        ...
        newpo.append('categories[]', this.postid); // var newpo= {
        // "title":this.title,
  ...
  function (module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "LoaderComponentComponent", function () {
      return LoaderComponentComponent;
    });
    /* harmony import */
    ...
    LoaderComponentComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-loader-component',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./loader-component.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/loader-component/loader-component.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./loader-component.component.scss */
      "./src/app/loader-component/loader-component.component.scss")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])], LoaderComponentComponent);
    /***/
  }
}]);
