    ...
    const Slides = class {
      ...
      disconnectedCallback() {
        ...
        return _asyncToGenerator(function* () {
          ...
          const swiper = yield _this2.getSwiper();
      ...
      update() {
        ...
        return _asyncToGenerator(function* () {
          const [swiper] = yield Promise.all([_this3.getSwiper(), waitForSlides(_this3.el)]);
          swiper.update();
        })();
      }
      /**
      ...
      lockSwipes(lock) {
        ...
        return _asyncToGenerator(function* () {
          const swiper = yield _this17.getSwiper();
          swiper.allowSlideNext = !lock;
          swiper.allowSlidePrev = !lock;
      ...
      initSwiper() {
        ...
        return _asyncToGenerator(function* () {
          const finalOptions = _this19.normalizeOptions(); // init swiper core
          // @ts-ignore


          const {
            Swiper
          } = yield __webpack_require__.e(
          ...
          yield waitForSlides(_this19.el);
          const swiper = new Swiper(_this19.el, finalOptions);
