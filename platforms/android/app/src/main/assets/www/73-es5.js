    ...
    const Toast = class {
      ...
      present() {
        ...
        return _asyncToGenerator(function* () {
          yield Object(_overlays_10640d86_js__WEBPACK_IMPORTED_MODULE_4__["e"])(_this, 'toastEnter', iosEnterAnimation, mdEnterAnimation, _this.position);
      ...
      buttonClick(button) {
        ...
        return _asyncToGenerator(function* () {
          ...
          if (shouldDismiss) {
            return _this2.dismiss(undefined, button.role);
          }
      ...
      callButtonHandler(button) {
        return _asyncToGenerator(function* () {
          if (button && button.handler) {
            ...
            try {
              const rtn = yield Object(_overlays_10640d86_js__WEBPACK_IMPORTED_MODULE_4__["s"])(button.handler);
