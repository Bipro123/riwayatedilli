    ...
    const Popover = class {
      ...
      present() {
        ...
        return _asyncToGenerator(function* () {
          ...
          _this.usersElement = yield Object(_framework_delegate_c2e2e1f4_js__WEBPACK_IMPORTED_MODULE_7__["a"])(_this.delegate, container, _this.component, ['popover-viewport', _this.el['s-sc']], data);
          yield Object(_index_4d91f03a_js__WEBPACK_IMPORTED_MODULE_8__["d"])(_this.usersElement);
          return Object(_overlays_10640d86_js__WEBPACK_IMPORTED_MODULE_5__["e"])(_this, 'popoverEnter', iosEnterAnimation, mdEnterAnimation, _this.event);
        })();
      }
      /**
      ...
      dismiss(data, role) {
        ...
        return _asyncToGenerator(function* () {
          const shouldDismiss = yield Object(_overlays_10640d86_js__WEBPACK_IMPORTED_MODULE_5__["f"])(_this2, data, role, 'popoverLeave', iosLeaveAnimation, mdLeaveAnimation, _this2.event);

          if (shouldDismiss) {
            yield Object(_framework_delegate_c2e2e1f4_js__WEBPACK_IMPORTED_MODULE_7__["d"])(_this2.delegate, _this2.usersElement);
          }
