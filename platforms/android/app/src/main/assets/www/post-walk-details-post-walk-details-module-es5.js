(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["post-walk-details-post-walk-details-module"], {
  ...
  function (module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "PostwalkdetailsPageModule", function () {
      return PostwalkdetailsPageModule;
    });
    /* harmony import */
    ...
    var _post_walk_details_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./post-walk-details.page */
    "./src/app/post-walk-details/post-walk-details.page.ts");

    let PostwalkdetailsPageModule = class PostwalkdetailsPageModule {};
    PostwalkdetailsPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  function (module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "PostwalkdetailsPage", function () {
      return PostwalkdetailsPage;
    });
    /* harmony import */
    ...
    let PostwalkdetailsPage = class PostwalkdetailsPage {
      constructor(navCtrl, socialSharing, toastController, platform, loadingCtrl, http, route, router, modal, storage) {
        ...
        this.isLoading = false; // this.postid =this.route.snapshot.paramMap.get('id');

        this.route.params.subscribe(params => {
          this.postid = params.id;
        });
        storage.get('postlist').then(val => {
          this.details = Array.of(val); // for(let post of this.details){
          ...
          let parsedHtml = parser.parseFromString(amg, 'text/html'); // console.log(parsedHtml);

          this.narrative = parsedHtml.getElementById("walk").innerHTML;
          this.timeinout = parsedHtml.getElementById("timeinout").innerHTML;
          this.entryfee = parsedHtml.getElementById("entryfee").innerHTML; // this.loadingdismiss(); 
      ...
      ngOnDestroy() {} // this.loadingdismiss();
      // this.backbttunsub();
      // backbttsub()
      // {
    ...
    PostwalkdetailsPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-postwalkdetails',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./post-walk-details.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/post-walk-details/post-walk-details.page.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./post-walk-details.page.scss */
      "./src/app/post-walk-details/post-walk-details.page.scss")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"], _ionic_native_social_sharing_ngx__WEBPACK_IMPORTED_MODULE_7__["SocialSharing"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ToastController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["LoadingController"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"], _ionic_storage__WEBPACK_IMPORTED_MODULE_8__["Storage"]])], PostwalkdetailsPage);
    /***/
  }
}]);
//# sourceMappingURL=post-walk-details-post-walk-details-module-es5.js.map