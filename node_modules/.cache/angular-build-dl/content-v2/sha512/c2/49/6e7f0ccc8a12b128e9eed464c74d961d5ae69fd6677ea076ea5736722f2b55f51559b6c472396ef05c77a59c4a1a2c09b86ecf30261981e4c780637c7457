...
`);
          ...
          _this.gesture = (yield Promise.resolve().then(__webpack_require__.bind(null,
          /*! ./index-624eea58.js */
      ...
      loadAnimation() {
        ...
        return _asyncToGenerator(function* () {
          ...
          _this4.animation = yield _index_1e5940d5_js__WEBPACK_IMPORTED_MODULE_5__["m"]._createAnimation(_this4.type, _this4);
    ...
    function () {
      var _ref = _asyncToGenerator(function* (menu) {
        const menuEl = yield _index_1e5940d5_js__WEBPACK_IMPORTED_MODULE_5__["m"].get(menu);
    ...
    const MenuButton = class {
      constructor(hostRef) {
        ...
        _asyncToGenerator(function* () {
          return _index_1e5940d5_js__WEBPACK_IMPORTED_MODULE_5__["m"].toggle(_this6.menu);
        });
      }
