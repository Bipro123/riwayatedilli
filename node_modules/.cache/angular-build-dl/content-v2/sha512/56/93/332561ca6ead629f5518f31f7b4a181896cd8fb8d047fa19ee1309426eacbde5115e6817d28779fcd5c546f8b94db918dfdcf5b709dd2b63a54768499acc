  ...
  function (module, __webpack_exports__, __webpack_require__) {
    ...
    const Header = class {
      ...
      checkCollapsibleHeader() {
        ...
        return _asyncToGenerator(function* () {
          ...
          const canCollapse = hasCollapse && Object(_core_feeeff0d_js__WEBPACK_IMPORTED_MODULE_0__["c"])(_this4) === 'ios' ? hasCollapse : false;
    ...
    const RouterOutlet = class {
      ...
      connectedCallback() {
        ...
        return _asyncToGenerator(function* () {
          _this6.gesture = (yield __webpack_require__.e(
          /*! import() | swipe-back-35ad8e37-js */
          "swipe-back-35ad8e37-js").then(__webpack_require__.bind(null,
          /*! ./swipe-back-35ad8e37.js */
          "./node_modules/@ionic/core/dist/esm/swipe-back-35ad8e37.js"))).createSwipeBackGesture(_this6.el, () => !!_this6.swipeHandler && _this6.swipeHandler.canStart() && _this6.animationEnabled, () => _this6.swipeHandler && _this6.swipeHandler.onStart(), step => _this6.ani && _this6.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (_this6.ani) {
      ...
      setRoot(component, params, opts) {
        ...
        return _asyncToGenerator(function* () {
          ...
          const enteringEl = yield Object(_framework_delegate_c2e2e1f4_js__WEBPACK_IMPORTED_MODULE_5__["a"])(_this10.delegate, _this10.el, component, ['ion-page', 'ion-page-invisible'], params);
          ...
          yield Object(_framework_delegate_c2e2e1f4_js__WEBPACK_IMPORTED_MODULE_5__["d"])(_this10.delegate, leavingEl);
          return true;
        })();
      }
      ...
      transition(enteringEl, leavingEl, opts = {}) {
        ...
        return _asyncToGenerator(function* () {
          ...
          const animated = _this11.animated && _config_3c7f3790_js__WEBPACK_IMPORTED_MODULE_1__["b"].getBoolean('animated', true);

          const animationBuilder = _this11.animation || opts.animationBuilder || _config_3c7f3790_js__WEBPACK_IMPORTED_MODULE_1__["b"].get('navAnimation');

          yield Object(_index_4d91f03a_js__WEBPACK_IMPORTED_MODULE_6__["t"])(Object.assign({
            mode,
            animated,
            animationBuilder,
            enteringEl,
